...
def test_that_cpp_complexity_can_be_counted
  ...
  total = count_complexity('.cpp') + count_complexity('.cc') + count_complexity('.c++')
  Dir.chdir('../../')
